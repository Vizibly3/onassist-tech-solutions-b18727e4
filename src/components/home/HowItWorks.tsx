...
const steps = [
  {
    ...
    description: 'Browse our catalog of tech support services and select the one that matches your needs.',
    icon: (
  ...
  },
  {
    ...
    description: 'Select a date and time that works best for you, and we will schedule a tech expert to help.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Our qualified technician will arrive at your location to solve your tech problems.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Enjoy your properly working tech with the peace of mind of our satisfaction guarantee.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            We make getting tech support simple and stress-free. Our process is designed 
            to get your tech problems solved quickly and effectively.
          </p>
        </div>
