          ...
          <AuthProvider>
            <CartProvider>
              <Routes>
                ...
                <Route path="/:stateSlug/:citySlug" element={<CityServicePage />} />
                <Route path="/:stateSlug/:citySlug/:categorySlug" element={<CityCategoryPage />} />
                <Route path="/:stateSlug/:citySlug/:categorySlug/:serviceSlug" element={<LocationServiceDetailPage />} />
                ...
                <Route path="/sitemap_index.xml" element={<SitemapMainPage />} />
