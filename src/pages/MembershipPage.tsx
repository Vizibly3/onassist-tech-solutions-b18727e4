        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-4 mb-12">
              <span className={`text-lg font-medium ${!isYearly ? 'text-yellow-300' : 'text-white/70'}`}>
                Monthly
              </span>
              <Switch
                checked={isYearly}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => {
              ...
              return (
                <Card key={index} className={`relative overflow-hidden shadow-2xl border-0 ${plan.popular ? 'transform scale-105 lg:scale-110' : ''} hover:shadow-3xl transition-all duration-300`}>
                  {plan.popular && (
                  ...
                  <CardHeader className={`bg-gradient-to-br ${plan.color} text-white relative ${plan.popular ? 'pt-16' : 'pt-8'} pb-8`}>
                    ...
                    <div className="space-y-4 mb-8">
                      {plan.features.map((feature, featureIndex) => (
                        <div key={featureIndex} className="flex items-center gap-3">
                          <div className={`bg-gradient-to-br ${plan.color} w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0`}>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Why Choose Our <span className="text-onassist-primary">Membership?</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-onassist-dark to-blue-900 text-white relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready to Get <span className="text-yellow-300">Premium Support?</span>
            </h2>
