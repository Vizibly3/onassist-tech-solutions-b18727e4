...
import { Home, Phone, Search, ArrowLeft, Wrench, AlertTriangle } from 'lucide-react';
        ...
        <div className="text-center max-w-2xl mx-auto px-4">
          ...
          <div className="space-y-6 mb-12">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-md mx-auto">
              The page you're looking for seems to have wandered off. Don't worry, our tech experts can help you find your way!
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button asChild size="lg" className="bg-gradient-to-r from-onassist-primary to-blue-600 hover:from-onassist-primary/90 hover:to-blue-600/90 text-white font-bold px-8 py-4 rounded-full shadow-lg">
              <Link to="/">
            ...
            <Button asChild size="lg" variant="outline" className="border-2 border-onassist-primary text-onassist-primary hover:bg-onassist-primary hover:text-white font-bold px-8 py-4 rounded-full">
              <Link to="/services">
            ...
            <Button asChild size="lg" variant="outline" className="border-2 border-green-500 text-green-600 hover:bg-green-500 hover:text-white font-bold px-8 py-4 rounded-full">
              <Link to="/contact">
