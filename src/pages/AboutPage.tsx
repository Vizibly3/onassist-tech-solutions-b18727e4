  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Learn about ${config.name} - your trusted partner for professional tech support services. Discover our mission, values, and commitment to excellence.`}
        />
      </Helmet>
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-2xl opacity-90 mb-8 leading-relaxed">
              Delivering exceptional technology support services with a
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              These values guide everything we do, ensuring we deliver the best
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "We are dedicated to understanding and meeting the needs of our customers with personalized solutions.",
              },
              {
                icon: Award,
                title: "Excellence",
                description:
                  "We strive for excellence in every aspect of our service, ensuring top-quality support and solutions.",
              },
            ].map((value, index) => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  We offer more than just tech support - we provide peace of
                  mind. Our commitment to quality, reliability, and customer
              ...
              <div>
                    ...
                    <div className="grid grid-cols-2 gap-6 text-center">
                      <div>
                        <div className="text-3xl font-bold mb-2">
                          {config.rating_stat || "4.9/5"}
                        </div>
                        <div className="text-white/90">Customer Rating</div>
                      </div>
                      <div>
                        <div className="text-3xl font-bold mb-2">
                          {config.happy_customers_stat || "10K+"}
                        </div>
                ...
                <Card className="bg-gray-50 shadow-lg mt-8 border-0">
                  <CardContent className="p-8">
                    <h3 className="text-xl font-bold mb-4 text-onassist-primary">
                      Our Mission
                    </h3>
                    <p className="text-gray-700">
                      To provide reliable, efficient, and friendly tech support
                      services that empower our customers to thrive in a digital
                      world.
                    </p>
                  </CardContent>
                </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12">
              Learn about our history, our team, and our commitment to the
              community.
            </p>
              ...
              {[
                {
                  ...
                  title: "Our History",
                  description:
                    "Founded in 2015, we've grown from a small startup to a leading tech support provider, serving thousands of customers.",
                },
                {
                  icon: Users,
                  title: "Our Team",
                  description:
                    "Our team of certified technicians and support staff are dedicated to providing exceptional service and expertise.",
                },
                {
                  icon: Target,
                  title: "Our Vision",
                  description:
                    "To be the most trusted and reliable tech support partner, empowering individuals and businesses to achieve their goals.",
                },
              ].map((info, index) => {
