        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Button 
                size="lg" 
                className="bg-orange-500 text-white hover:bg-orange-600 border-2 border-orange-500 hover:border-orange-600 text-lg px-8 py-6 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-1"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h2 className="text-4xl font-bold mb-6 text-gray-900">
                  Expert {categoryTitle} Solutions
                </h2>
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  {category.description || `Our certified technicians specialize in ${categoryTitle.toLowerCase()} services, bringing years of experience and cutting-edge solutions to your doorstep. We understand the unique challenges in this field and deliver results that exceed expectations.`}
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-4 rounded-xl">
                    <Shield className="w-8 h-8 text-blue-600 mb-2" />
                    <h3 className="font-bold text-gray-900">Guaranteed Work</h3>
