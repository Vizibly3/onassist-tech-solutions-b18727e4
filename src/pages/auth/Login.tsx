  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Sign in to your ${config.name} account to access premium tech support services.`}
        />
      </Helmet>
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            >
              ...
              <p className="text-white/80">
                Professional Smart Doorstep Support
              </p>
            </Link>
          </div>
          ...
          <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <form
                onSubmit={
                  forgotPasswordMode ? handleForgotPassword : handleLogin
                }
                className="space-y-4"
              >
